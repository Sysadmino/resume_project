...
from resume_tests.src.parsing.utils import from_cyrillic_to_eng


def default_urls():
    return {"work_2": "", "work_3": "", "work_4": ""}
...
class Resume(models.Model):
    ...
    title = models.CharField(max_length=250, verbose_name='Заголовок резюме')
